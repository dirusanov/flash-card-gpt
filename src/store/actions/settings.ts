...
export const SET_IMAGE_GENERATION_MODE = 'SET_IMAGE_GENERATION_MODE';
...
export const setImageGenerationMode = (mode: 'off' | 'smart' | 'always') => ({
    type: SET_IMAGE_GENERATION_MODE,
    payload: mode,
});
